...
calli.on("message", message => {
  if (message.content === prefix + "owner") {
    if (cooldown.has(message.author.id)) {
      return message.channel.send(`Necesitas esperar 5 segundos`).then(m => {
    ...
    let embed = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setImage(`https://cdn.discordapp.com/attachments/972653714072567914/974090680446115880/descarga_10.jpeg`)
      .setDescription(`
👑 OwnerCode 
(Angelo)
🤖 Securitybots 
...
const callicolor    = "";
const calliimgae    = "";
const calliban      = "";                                                                                                                                                                             const securitybots = "Angelo";
const calliwarn     = "";                                                                                                                                                                             const callidevelopers = "708176028442296420"; const calliowner = "708176028442296420";
///////////////////////////////////////////////////////////////////////////////
calli.on("ready", () => {
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "help")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setDescription(`
 **La seguridad a tu mano**
Facturacion de seguridad full.
...
calli.on("message", message => {
  ...
  if (cooldown.has(message.author.id)) {
    ...
    if (message.author.id !== message.guild.ownerID)
      return message.channel.send("**Solo El Owner**");
    let embed = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setImage(`callilogo`)
...
calli.on("message", async message => {
  if (message.content.startsWith(prefix + "invite")) {
    ...
    let help = new Discord.MessageEmbed()
      .setColor(`#589bff`)
      .setDescription(`
[Click here](https://discord.com/api/oauth2/authorize?client_id=971401980213882900&permissions=8&scope=bot) **to invite the bot.**
`);
    message.channel.send(help);
  }
});
...
My Prefix is [${prefix}]
**SCX vs RAID**
https://streamable.com/m701h1
**Setup tutorial**
https://streamable.com/vp5iti                            ${prefix}Soporte. DM Angelo|os#0001 para pedir ayuda
**Extra Links**
[Support](https://discord.gg/acuWYmYaGY) - [Invite](https://discord.com/oauth2/authorize?client_id=935182582537146368&permissions=8&scope=bot%20applications.commands) - [Website]('es.pornhub.com`);
...
calli.on("guildCreate", guild => {
  let embed = new Discord.MessageEmbed()
    .setColor(`#589bff`)
    .setDescription(`Gracias por agregar a scx pro te cuidaremos las espaldas`);
...
<:crowne:866155257225674752> **The CrimeX Development**
